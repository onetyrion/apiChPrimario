//IMPORTS
const { users, login, rol, areaProductiva, usuarioAreaProductiva, mantencion, fallaMantencion, evento, componente, categoria, tipoFalla, falla,	maquinaria,	reporteKPI,	kpi, programaMantencion, tipoMantencion, fallaComponente, tipoMaquinaria, indicador,empresa } = require("../database/database");
...
const validExist = async(tabla,valor,campo,logic) => {
    ...
    item = (tabla === "empresa") ? await empresa.findAll({ where:{ [campo]:valor }}) : [...item];
